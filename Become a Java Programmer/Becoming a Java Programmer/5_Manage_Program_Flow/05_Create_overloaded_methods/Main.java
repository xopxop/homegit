...
public class Main {
	public static void main(String[] args) {
		...
		var i1 = getInput(sc, "Enter numeric value 1: ");
		var i2 = getInput(sc, "Enter numeric value 2: ");

		double result = addValues(i1, i2);
		System.out.println("The answer is " + result);

		double resultOfFour = addValues(i1, i2, i1, i2);
		System.out.println("The answer of 4 is " + resultOfFour);

		double resultOfMultiple = addValues(i1, i2, i1, i2, i1, i2);
		System.out.println("The answer of multiple is " + resultOfMultiple);
	}
